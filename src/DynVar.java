...
public class DynVar {
    ...
    public boolean isTrue(){
        if (type == VarType.BOOLEAN){
            ...
            throw new DynVarException(ID, this, "DynVar is not a Boolean for OP: isTrue");
        }
    }
    public boolean isFalse(){
        if (type == VarType.BOOLEAN){
            ...
            throw new DynVarException(ID, this, "DynVar is not a Boolean for OP: isFalse");
        }
    }
    public boolean isMore(DynVar IN){
        if (IN.type == VarType.NUMBER && type == VarType.NUMBER){
            ...
            throw new DynVarException(ID, this, IN.getID(), IN, "DynVar Values Do Not Match NUMBER Type in OP: isMore");
        }
    }
    public boolean isLess(DynVar IN){
        if (IN.type == VarType.NUMBER && type == VarType.NUMBER){
            ...
            throw new DynVarException(ID, this, IN.getID(), IN, "DynVar Values Do Not Match NUMBER Type in OP: isLess");
        }
    }
    public boolean isMoreEq(DynVar IN){
        if (IN.type == VarType.NUMBER && type == VarType.NUMBER){
            ...
            throw new DynVarException(ID, this, IN.getID(), IN, "DynVar Values Do Not Match NUMBER Type in OP: isMoreEq");
        }
    }
    public boolean isLessEq(DynVar IN){
        if (IN.type == VarType.NUMBER && type == VarType.NUMBER){
            ...
            throw new DynVarException(ID, this, IN.getID(), IN, "DynVar Values Do Not Match NUMBER Type in OP: isLessEq");
        }
    }
        ...
        switch (type){
            ...
            case JSON:
                ...
                for (Map.Entry<DynVar, DynVar> entry : ((HashMap<DynVar, DynVar>) value).entrySet()){
                    out += "DynVar: " + i + " Value: " + entry.getValue();
